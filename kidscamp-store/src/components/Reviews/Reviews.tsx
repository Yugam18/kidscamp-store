                        ...
                        {starDistribution.map((item) => (
                            <div key={item.stars} className={styles.distributionRow}>
                                <div className={styles.starGroup}>
                                    ...
                                    <svg className={styles.starIcon} width="16" height="16" viewBox="0 0 24 24" fill="#FFD700">
                                        <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                                    </svg>
                                </div>
                ...
                <div className={styles.customerReview}>
                    <div className={styles.reviewCard}>
                        <div className={styles.reviewHeader}>
                            <h3 className={styles.reviewerName}>{reviews[currentReviewIndex].name}</h3>
                            <span className={styles.reviewDate}>{reviews[currentReviewIndex].date}</span>
                        </div>
