...
export class ProductsApiService {
    ...
    static async getProductsWithFilters(filters: {
        ...
        try {
            ...
            if (filters.sizes) filters.sizes.forEach(size => searchParams.append('size', size));
            if (filters.colors) filters.colors.forEach(color => searchParams.append('color', color));
